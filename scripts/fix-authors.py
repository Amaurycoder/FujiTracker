...
try:
    ...
    for recipe in recipes:
        correct_author = RECIPE_AUTHOR_CORRECTIONS.get(recipe['name'])
        if correct_author and recipe.get('author') != correct_author:
            print(f'✏️  Correcting "{recipe["name"]}": "{recipe.get("author", "N/A")}" → "{correct_author}"')
